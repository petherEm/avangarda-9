...
const WorkInProgress = ({ dict, lang }: AboutProps) => {
  return (
      ...
      <div className="absolute top-0 right-0 h-full flex items-center">
        ...
        >
          ...
          >
            ...
            itaque iure asperiores ducimus doloribus veniam odit laboriosam
            velit quibusdam dignissimos sequi possimus architecto molestiae
            quaerat porro, incidunt praesentium corporis alias dolore iusto.
            Soluta odio maxime consequuntur facilis aperiam officia?
          </motion.p>
