        ...
        <section className="relative z-20">
          <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div className="block lg:hidden">
              ...
              {/* Mobile Images - Simple stacked with parallax */}
              <motion.div
            ...
            <div className="hidden lg:grid lg:grid-cols-2 gap-16 xl:gap-20 items-center">
              ...
              >
                <div className="relative h-[800px] xl:h-[900px] overflow-visible z-20">
                  ...
                  {/* Secondary Image - Starts at 30% from bottom of first image, moves down with parallax */}
                  <motion.div
                    ...
                    style={{
                      top: "30%", // Starts at 30% from top (which is 30% down from the bottom of first image)
                      y: secondaryImageY,
                      scale: imageScale,
                      zIndex: 60,
                    }}
                  >
                    <div className="relative h-full w-full overflow-hidden shadow-xl">
                      <Image
                        ...
                        fill
                        className="object-cover transition-all duration-1000 hover:scale-110"
                        sizes="(max-width: 1200px) 55vw, 45vw"
                      />
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent"
                        initial={{ opacity: 0 }}
